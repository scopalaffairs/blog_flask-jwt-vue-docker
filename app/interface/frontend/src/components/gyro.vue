    ...
    <div class="container">
        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-pills" role="tablist">
                <li role="presentation" class="active"><a href="#do" aria-controls="do" role="tab"
                                                          data-toggle="tab">Orientation</a></li>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="do">
                    ...
                    <input type="button" onclick="set_head_gn()" value="Set Head Direction"
                           class="col-xs-12 btn-warning btn"/>
        ...
        <textarea class="col-xs-12 form-control" id="error-message" style="height:100px" placeholder="Log area..."
                  disabled></textarea>
                </div>
            </div>
